 ...
 # --- CRITICAL FIX: Force clean to prevent stale cache ---
 log "🧹 Cleaning stale cache..."
 ...
 cp "${THEMES_DIR}/plymouth/images/novaos-logo.png" "${CHROOT}/usr/share/pixmaps/novaos-logo.png" 2>/dev/null || 
true
